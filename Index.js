...
function threes() {
    if (document.getElementById(`threes--${playerTurn}`).textContent == "-") return
    let threes = 0;
    for (i = 1; i < 6; i++) {
        let number = getNumber(i)
        if (number == 3) {
...
function fours() {
    if (document.getElementById(`fours--${playerTurn}`).textContent == "-") return
    let fours = 0;
    for (i = 1; i < 6; i++) {
        let number = getNumber(i)
...
function fives() {
    if (document.getElementById(`fives--${playerTurn}`).textContent == "-") return
    let fives = 0;
    for (i = 1; i < 6; i++) {
        let number = getNumber(i)
...
function sixes() {
    if (document.getElementById(`sixes--${playerTurn}`).textContent == "-") return
    let sixes = 0;
    for (i = 1; i < 6; i++) {
        let number = getNumber(i)
...
function threeOfAKind() {
    if (document.getElementById(`tkind--${playerTurn}`).textContent == "-") return
    let ones = 0;
    let twos = 0;
    let threes = 0;
    let fours = 0;
...
function fourOfAKind() {
    if (document.getElementById(`fkind--${playerTurn}`).textContent == "-") return
    let ones = 0;
    let twos = 0;
    let threes = 0;
    let fours = 0;
...
function fullHouse() {
    if (document.getElementById(`fouse--${playerTurn}`).textContent == "-") return
...
function smallStraight() {
    if (document.getElementById(`small--${playerTurn}`).textContent == "-") return
    const numbers = [];
    let totalScore = 0;
    ...
    if (
        ...
        (numbers[0] === 2 && numbers[1] === 3 && numbers[2] === 4 && numbers[3] === 5) ||
...
function largeStraight() {
    if (document.getElementById(`large--${playerTurn}`).textContent == "-") return
    const numbers = [];
    let totalScore = 0;
...
function yahtzee() {
    if (document.getElementById(`yahtzee--${playerTurn}`).textContent == "-") return
    let ones = 0;
    let twos = 0;
    let threes = 0;
    let fours = 0;
...
function chance() {
    if (document.getElementById(`chance--${playerTurn}`).textContent == "-") return
...
function calculateTotalTop() {
    ...
    let aces = parseInt(document.getElementById(`aces--${playerTurn}--locked`).textContent)
    ...
    console.log("totalaldlsdlal " + totalScore)
    if (totalScore >= 63) {
...
function calculateSubTotalBottom() {
    ...
    let tkind = parseInt(document.getElementById(`tkind--${playerTurn}--locked`).textContent)
    let fkind = parseInt(document.getElementById(`fkind--${playerTurn}--locked`).textContent)
    let fouse = parseInt(document.getElementById(`fouse--${playerTurn}--locked`).textContent)
    ...
    document.getElementById(`total--${playerTurn}--locked--bottom`).textContent = totalScore;
    document.getElementById(`bottom--${playerTurn}--total`).textContent = totalScore;
}

function calculateTotal() {
    let totalScore = 0;

    let totalTop = parseInt(document.getElementById(`total--${playerTurn}--locked--top`).textContent)
    let totalBottom = parseInt(document.getElementById(`total--${playerTurn}--locked--bottom`).textContent)

    totalScore = totalTop + totalBottom
    document.getElementById(`grand--${playerTurn}--locked`).textContent = totalScore;
}
